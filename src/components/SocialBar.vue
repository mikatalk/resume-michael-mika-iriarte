  ...
  <div class="social-bar">
    <div class="social-bar-inner">
      ...
      <ul>
        ...
        <li class="portfolio">
          <a href="https://www.michael-iriarte.com/">
        ...
        <li class="linkedin">
          <a href="https://www.linkedin.com/in/mikairiarte/">
        ...
        <li class="twitter">
          <a href="https://twitter.com/michael_iriarte">
            <svg class="icon" focusable="false"  viewBox="0 0 1792 1792" width="16" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="stack-overflow">
          <a href="https://stackoverflow.com/users/1515589/mika">
            <svg class="icon" focusable="false"  viewBox="0 0 1792 1792" width="16" xmlns="http://www.w3.org/2000/svg">
